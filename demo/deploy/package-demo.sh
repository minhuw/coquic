...
for required_file in index.html workbench.html demo-theme.css coquic-logo.svg quic-demo.js perf-comparison.html perf-comparison.js interop-results.html interop-results.js coquic-wasm-quic.wasm; do

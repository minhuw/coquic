...
def _system_prompt() -> str:
    return (
        ...
        "the answer concise and practical. Wrap packet diagrams, frame layouts, "
        "and other fixed-width ASCII art in triple-backtick Markdown code blocks."
    )

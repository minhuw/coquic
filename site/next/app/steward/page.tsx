...
import dashboardStyles from '@/components/steward/dashboard.module.css';
  ...
  return (
    <main className={`coquic-page steward-dashboard-page steward-dashboard-route ${dashboardStyles.route}`} data-steward-surface="dashboard">
      <PageHeader
        ...
        variant="operations"
      />
      <section aria-label="Steward dashboard" className={`steward-dashboard-page-content ${dashboardStyles.content}`}>

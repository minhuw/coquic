...
using coquic::quic::test::PacketCryptoFaultPoint;
...
void set_packet_crypto_fault_state(std::optional<PacketCryptoFaultPoint> fault_point,
...
ScopedPacketCryptoFaultInjector::ScopedPacketCryptoFaultInjector(PacketCryptoFaultPoint fault_point,
                                                                 std::size_t occurrence)
    : previous_fault_point_(packet_crypto_fault_state().fault_point),
      previous_occurrence_(packet_crypto_fault_state().occurrence) {
    set_packet_crypto_fault_state(fault_point, occurrence);
}

ScopedPacketCryptoFaultInjector::~ScopedPacketCryptoFaultInjector() {
    set_packet_crypto_fault_state(previous_fault_point_, previous_occurrence_);
}

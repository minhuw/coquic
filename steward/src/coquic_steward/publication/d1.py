...
def _validated_envelope(
    ...
    *,
    ...
    """Map transport-neutral envelope categories to D1's stable error type."""

    try:
        return validate_publication_envelope(
            source,
            allow_usage_replacement=allow_usage_replacement,
        )
    except EnvelopeError as error:
        try:
            code = D1ErrorCode(error.code)
        except (TypeError, ValueError):
            code = D1ErrorCode.invalid_request
        raise D1Error(code) from None
...
class D1PublicationClient:
    ...
    def stage(self, source: Mapping[str, Any]) -> StageReceipt:
        payload = _validated_envelope(source)
    ...
    def replace_usage(
        ...
        *,
        ...
        payload = _validated_envelope(source, allow_usage_replacement=True)
    ...
    def _build_price_backfill(
        ...
        *,
        ...
        usage["generation"]["metadataDigest"] = usage_metadata_digest(payload)

...
TEST(QuicHttp09RuntimeTest, RuntimeHelperExtendsClientReceiveTimeoutForMulticonnect) {
    ...
    EXPECT_EQ(coquic::http09::test::client_receive_timeout_ms_for_tests(multiconnect), 180000);
}
...
TEST(QuicHttp09RuntimeTest, RuntimeHelperHooksSelectEarliestWakeupAcrossEntries) {
    ...
    const auto earliest = coquic::http09::test::earliest_runtime_wakeup_for_tests(wakeups);
...
TEST(QuicHttp09RuntimeTest, RuntimeHelperHooksDriveEndpointUntilBlockedFailureCases) {
    const auto handle_core_effects_fail =
        coquic::http09::test::drive_endpoint_until_blocked_case_for_tests(
            coquic::http09::test::DriveEndpointUntilBlockedCaseForTests::handle_core_effects_fail);
    ...
    const auto initial_local_error =
        coquic::http09::test::drive_endpoint_until_blocked_case_for_tests(
            coquic::http09::test::DriveEndpointUntilBlockedCaseForTests::initial_local_error);
    ...
    const auto endpoint_failure = coquic::http09::test::drive_endpoint_until_blocked_case_for_tests(
        coquic::http09::test::DriveEndpointUntilBlockedCaseForTests::endpoint_failure);
...
TEST(QuicHttp09RuntimeTest, RuntimeHelperHooksDriveEndpointUntilBlockedSuccessCase) {
    const auto success = coquic::http09::test::drive_endpoint_until_blocked_case_for_tests(
        coquic::http09::test::DriveEndpointUntilBlockedCaseForTests::endpoint_success);
...
TEST(QuicHttp09RuntimeTest, RuntimeHelperHooksDriveClientConnectionLoopCases) {
    const auto initial_terminal_success =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::initial_terminal_success);
    ...
    const auto timer_due_then_wait_failure =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::timer_due_then_wait_failure);
    ...
    const auto timer_due_then_drive_failure =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::timer_due_then_drive_failure);
    ...
    const auto outer_timer_then_wait_failure =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::outer_timer_then_wait_failure);
    ...
    const auto outer_timer_then_drive_failure =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::outer_timer_then_drive_failure);
    ...
    const auto pending_work_terminal_failure =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::pending_work_terminal_failure);
    ...
    const auto wait_failure = coquic::http09::test::run_client_connection_loop_case_for_tests(
        coquic::http09::test::ClientConnectionLoopCaseForTests::wait_failure);
    ...
    const auto outer_pump_terminal_failure =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::outer_pump_terminal_failure);
    ...
    const auto outer_pump_terminal_success =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::outer_pump_terminal_success);
    ...
    const auto wait_input_then_drive_failure =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::wait_input_then_drive_failure);
    ...
    const auto wait_input_missing_failure =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::wait_input_missing_failure);
    ...
    const auto wait_input_then_nonterminal_idle_timeout_failure =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::
                wait_input_then_nonterminal_idle_timeout_failure);
    EXPECT_EQ(wait_input_then_nonterminal_idle_timeout_failure.exit_code, 1);
    EXPECT_FALSE(wait_input_then_nonterminal_idle_timeout_failure.terminal_success);
    EXPECT_FALSE(wait_input_then_nonterminal_idle_timeout_failure.terminal_failure);
    EXPECT_EQ(wait_input_then_nonterminal_idle_timeout_failure.wait_calls, 2U);
    ...
    const auto pending_work_terminal_failure_state_after_pump =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::
                pending_work_terminal_failure_state_after_pump);
    EXPECT_EQ(pending_work_terminal_failure_state_after_pump.exit_code, 1);
    EXPECT_FALSE(pending_work_terminal_failure_state_after_pump.terminal_success);
    EXPECT_TRUE(pending_work_terminal_failure_state_after_pump.terminal_failure);

    const auto nonblocking_receive_terminal_failure_state =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::
                nonblocking_receive_terminal_failure_state);
    EXPECT_EQ(nonblocking_receive_terminal_failure_state.exit_code, 1);
    EXPECT_FALSE(nonblocking_receive_terminal_failure_state.terminal_success);
    EXPECT_TRUE(nonblocking_receive_terminal_failure_state.terminal_failure);

    const auto advanced_core_without_pending_work_returns_success =
        coquic::http09::test::run_client_connection_loop_case_for_tests(
            coquic::http09::test::ClientConnectionLoopCaseForTests::
                advanced_core_without_pending_work_returns_success);
    EXPECT_EQ(advanced_core_without_pending_work_returns_success.exit_code, 1);
    EXPECT_FALSE(advanced_core_without_pending_work_returns_success.terminal_success);
    EXPECT_FALSE(advanced_core_without_pending_work_returns_success.terminal_failure);
    EXPECT_EQ(advanced_core_without_pending_work_returns_success.receive_calls, 1u);
    EXPECT_EQ(advanced_core_without_pending_work_returns_success.wait_calls, 0u);
}
...
TEST(QuicHttp09RuntimeTest, RuntimeHelperHooksDriveClientConnectionBackendLoopCases) {
    ...
    const auto shutdown = coquic::http09::test::run_client_connection_backend_loop_case_for_tests(
        coquic::http09::test::ClientConnectionBackendLoopCaseForTests::shutdown);
    ...
    const auto missing_rx_datagram =
        coquic::http09::test::run_client_connection_backend_loop_case_for_tests(
            coquic::http09::test::ClientConnectionBackendLoopCaseForTests::missing_rx_datagram);
    ...
    EXPECT_EQ(timer_due_before_wait_then_drive_failure.exit_code, 1);
    EXPECT_FALSE(timer_due_before_wait_then_drive_failure.terminal_success);
...
TEST(QuicHttp09RuntimeTest, RuntimeHelperHooksCoverServerFailureCleanupAndLoopCases) {
    {
        ...
        EXPECT_TRUE(coquic::http09::test::existing_server_session_failure_cleans_up_for_tests());
    }

    EXPECT_TRUE(coquic::http09::test::existing_server_session_failure_cleans_up_for_tests());
    EXPECT_TRUE(coquic::http09::test::existing_server_session_missing_input_fails_for_tests());
    EXPECT_TRUE(coquic::http09::test::expired_server_timer_failure_cleans_up_for_tests());
    EXPECT_TRUE(coquic::http09::test::expired_server_timer_success_preserves_session_for_tests());
    EXPECT_TRUE(coquic::http09::test::pending_server_work_failure_cleans_up_for_tests());
    EXPECT_TRUE(coquic::http09::test::pending_server_work_success_preserves_session_for_tests());
    EXPECT_TRUE(
        coquic::http09::test::version_negotiation_without_source_connection_id_fails_for_tests());

    const auto nonblocking_processed_timers_then_receive_error =
        coquic::http09::test::run_server_loop_case_for_tests(
            coquic::http09::test::ServerLoopCaseForTests::
    ...
    const auto nonblocking_process_datagram_failure =
        coquic::http09::test::run_server_loop_case_for_tests(
            coquic::http09::test::ServerLoopCaseForTests::nonblocking_process_datagram_failure);
    ...
    const auto blocking_timer_then_receive_error =
        coquic::http09::test::run_server_loop_case_for_tests(
            coquic::http09::test::ServerLoopCaseForTests::blocking_timer_then_receive_error);
    ...
    const auto blocking_wait_failure = coquic::http09::test::run_server_loop_case_for_tests(
        coquic::http09::test::ServerLoopCaseForTests::blocking_wait_failure);
    ...
    const auto blocking_wait_failure_with_preferred_socket =
        coquic::http09::test::run_server_loop_case_for_tests(
            coquic::http09::test::ServerLoopCaseForTests::
                blocking_wait_failure_with_preferred_socket);
    EXPECT_EQ(blocking_wait_failure_with_preferred_socket.exit_code, 1);
    EXPECT_EQ(blocking_wait_failure_with_preferred_socket.receive_calls, 2U);
    EXPECT_EQ(blocking_wait_failure_with_preferred_socket.wait_calls, 1U);
    EXPECT_EQ(blocking_wait_failure_with_preferred_socket.process_expired_calls, 2U);

    const auto blocking_wait_missing_input = coquic::http09::test::run_server_loop_case_for_tests(
        coquic::http09::test::ServerLoopCaseForTests::blocking_wait_missing_input);
    ...
    const auto blocking_wait_input_then_receive_error =
        coquic::http09::test::run_server_loop_case_for_tests(
            coquic::http09::test::ServerLoopCaseForTests::blocking_wait_input_then_receive_error);
    EXPECT_EQ(blocking_wait_input_then_receive_error.exit_code, 1);
    EXPECT_EQ(blocking_wait_input_then_receive_error.receive_calls, 2U);
    EXPECT_EQ(blocking_wait_input_then_receive_error.wait_calls, 1U);
    EXPECT_EQ(blocking_wait_input_then_receive_error.process_expired_calls, 3U);
    EXPECT_EQ(blocking_wait_input_then_receive_error.pump_calls, 2U);
    ...
    const auto ready_probe_due_timer_failure =
        coquic::http09::test::run_server_backend_scheduling_case_for_tests(
            coquic::http09::test::ServerBackendSchedulingCaseForTests::
                ready_probe_due_timer_failure);
    EXPECT_EQ(ready_probe_due_timer_failure.exit_code, 1);
    EXPECT_EQ(ready_probe_due_timer_failure.wait_calls, 1U);
    EXPECT_EQ(ready_probe_due_timer_failure.process_expired_calls, 1U);
    EXPECT_EQ(ready_probe_due_timer_failure.pump_calls, 1U);

    const auto ready_probe_idle_timeout_then_shutdown =
        coquic::http09::test::run_server_backend_scheduling_case_for_tests(
            coquic::http09::test::ServerBackendSchedulingCaseForTests::
    ...
    EXPECT_EQ(buffered_top_due_idle_timeout_skips_ready_probe.exit_code, 1);
    EXPECT_EQ(buffered_top_due_idle_timeout_skips_ready_probe.wait_calls, 1U);
    EXPECT_EQ(buffered_top_due_idle_timeout_skips_ready_probe.process_expired_calls, 0U);
    EXPECT_EQ(buffered_top_due_idle_timeout_skips_ready_probe.pump_calls, 2U);

    const auto ready_probe_rx_datagram_success_then_shutdown =
        coquic::http09::test::run_server_backend_scheduling_case_for_tests(
            coquic::http09::test::ServerBackendSchedulingCaseForTests::
                ready_probe_rx_datagram_success_then_shutdown);
    EXPECT_EQ(ready_probe_rx_datagram_success_then_shutdown.exit_code, 1);
    EXPECT_EQ(ready_probe_rx_datagram_success_then_shutdown.wait_calls, 2U);
    EXPECT_EQ(ready_probe_rx_datagram_success_then_shutdown.process_datagram_calls, 1U);
    EXPECT_EQ(ready_probe_rx_datagram_success_then_shutdown.process_expired_calls, 0U);

    const auto ready_probe_timer_without_wakeup_falls_back_to_main_wait =
        coquic::http09::test::run_server_backend_scheduling_case_for_tests(
            coquic::http09::test::ServerBackendSchedulingCaseForTests::
...
TEST(QuicHttp09RuntimeTest, RuntimeHelperHooksDriveServerBackendLoopCases) {
    const auto wait_failure = coquic::http09::test::run_server_backend_loop_case_for_tests(
        coquic::http09::test::ServerBackendLoopCaseForTests::wait_failure);
    EXPECT_EQ(wait_failure.exit_code, 1);
    EXPECT_EQ(wait_failure.wait_calls, 1U);

    const auto shutdown = coquic::http09::test::run_server_backend_loop_case_for_tests(
        coquic::http09::test::ServerBackendLoopCaseForTests::shutdown);
    EXPECT_EQ(shutdown.exit_code, 1);
    EXPECT_EQ(shutdown.wait_calls, 1U);

    const auto missing_rx_datagram = coquic::http09::test::run_server_backend_loop_case_for_tests(
        coquic::http09::test::ServerBackendLoopCaseForTests::missing_rx_datagram);
    EXPECT_EQ(missing_rx_datagram.exit_code, 1);
    EXPECT_EQ(missing_rx_datagram.wait_calls, 1U);

    const auto idle_timeout_then_shutdown =
        coquic::http09::test::run_server_backend_loop_case_for_tests(
            coquic::http09::test::ServerBackendLoopCaseForTests::idle_timeout_then_shutdown);
    ...
    const auto timer_event_then_shutdown =
        coquic::http09::test::run_server_backend_loop_case_for_tests(
            coquic::http09::test::ServerBackendLoopCaseForTests::timer_event_then_shutdown);
    ...
    const auto rx_datagram_then_shutdown =
        coquic::http09::test::run_server_backend_loop_case_for_tests(
            coquic::http09::test::ServerBackendLoopCaseForTests::rx_datagram_then_shutdown);
...
TEST(QuicHttp09RuntimeTest, RuntimeServerRouteHandlesAreStablePerPeerTuple) {
    EXPECT_TRUE(
        coquic::http09::test::runtime_server_route_handles_are_stable_per_peer_tuple_for_tests());
}
...
TEST(QuicHttp09RuntimeTest, RuntimeWaitHelperFailsWhenReadableSocketRecvfromFails) {
    ...
    EXPECT_FALSE(coquic::http09::test::wait_for_socket_or_deadline_for_tests(
                     /*socket_fd=*/-1, /*idle_timeout_ms=*/5, "client", std::nullopt)
                     .has_value());
}
